      ...
      <main className="tenant-profile-content">
        ...
        <div className="profile-details-card">
          <div className="profile-card-header">
            <div>
              <span className="building-name-small">Building Name</span>
            ...
            <div className="profile-top-badges">
              ...
              <button className="edit-profile-btn" aria-label="Edit Profile">✏️</button>
            </div>
          </div>
        ...
        <div className="profile-action-buttons">
          <button className="download-history-btn">Download History</button>
